...
export default function IndexPage() {
  return (
    <Layout>
      ...
      <p className="pb-[10px] break-words">
        '표현력이 좋은 개발자' 라고 말하면 어떨까요? 개발자의 일은 코드를 포함해
        대부분 글을 읽고 쓰는 일입니다. 그리고 글은 타인(혹은 컴퓨터)에게 잘
        전달되었을 때 의미가 있는 것이라고 할 때 - 좋은 표현력을 가진 글을 쓰는
        사람이 되고 싶어요.
      </p>
      ...
      <a href="mailto:nninnnin7@gmail.com">
        <address className="text-right bg-red-500 mt-10 p-5 ml-auto block w-fit rounded-2xl absolute right-[30px] bottom-[26px] font-medium not-italic">
          이메일 보내기
        </address>
      </a>
    </Layout>
